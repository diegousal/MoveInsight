...
def main() -> None:
    ...
    datos = df_angles.fillna(MASK_VALUE) 
    ...
    #     mask = (datos == MASK_VALUE) # Identificar dónde están los huecos
    #     datos_norm = (datos - mean) / std
    #     datos_norm[mask] = MASK_VALUE # Restaurar el valor exacto de la máscara
        
    #     input_tensor = np.expand_dims(datos_norm.values, axis=0)
